...
class NesterovGradientDescent private[spark] (private var gradient: Gradient, private var updater: NesterovUpdater)
  ...
  /**
    ...
    */
  def setUpdater(updater: NesterovUpdater): this.type = {
  ...
  def optimize(data: RDD[(Double, Vector)], initialWeights: Vector): Vector = {
    val (weights, _) = NesterovGradientDescent.runMiniBatchSGD(
      data,
      gradient,
      updater,
      momentumFraction,
...
/**
  ...
  */
@DeveloperApi
object NesterovGradientDescent extends Logging {
  /**
  ...
  def runMiniBatchSGD(
    ...
    while (!converged && i <= numIterations) {
      val bcWeights = data.context.broadcast(weightsShifted)
  ...
  def runMiniBatchSGD(
    ...
    NesterovGradientDescent.runMiniBatchSGD(data, gradient, updater, momentumFraction, stepSize, numIterations,
